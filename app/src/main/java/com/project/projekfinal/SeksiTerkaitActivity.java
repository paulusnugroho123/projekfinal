...
public class SeksiTerkaitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seksi_terkait);

        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Dasboard");
        drawerLayout = findViewById(R.id.drawer_seksi_terkait);
